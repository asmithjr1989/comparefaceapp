...
public class CompareFaceService {
    ...
    AmazonRekognition amazonRecognitionClient = AmazonRekognitionClientBuilder.standard().withRegion("us-east-2").build();
        ...
        try{
            ...
            if (!lists.isEmpty()){
                for(CompareFacesMatch label : lists){
                    imageResultsSameFace = ("The faces match and the similarity percentage is:  " + label.getSimilarity().toString());
    ...
    public String compareDiffFaces(String photo1, String photo3){
        ...
        try {
            ...
            if(!lists.isEmpty()){
                ...
                imageResultsDiffFaces = (" The faces for " + this.image1 + " and " +this.image3 + " do not match");
